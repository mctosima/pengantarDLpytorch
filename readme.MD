...
Jika anda ingin menggunakan GPU NVIDIA dalam proses komputasi (pada beberapa notebook), anda dapat mengikuti perintah berikut untuk instalasi PyTorch dengan dukungan pemrosesan GPU. Perhatikan bahwa GPU NVIDA anda (beserta *driver*-nya) juga harus mendukung CUDA toolkit 11.3.
